( function ( $ ) {
	...
	function bottomNavBorder() {
		...
		$('.nav-dash, .nav-api, .nav-profile, .nav-news, .nav-contacts, .nav-price').on('mouseover', function(){
			$(this).addClass('currentPageHover');
		});

		$('.nav-dash, .nav-api, .nav-profile, .nav-news, .nav-contacts, .nav-price').on('mouseout', function(){
...
addEventListener('DOMContentLoaded', function() {
    document.querySelector('#logo').setAttribute('class', 'animated rubberBand');
    setTimeout(function () {
        document.querySelector('#logo').setAttribute('class', 'animated bounceOutRight');
    },5000);
